...
*/
 ...
 if (!srs_settings.shared_gdal) {
    ...
    console.log('setting GDAL_DATA to',process.env.GDAL_DATA)
 } else {
    console.log(srs_settings.shared_gdal)
 }
...
var force_wgs84 = function(result) {
...
var parse = function(arg) {
    ...
    if (result.proj4 === undefined && esri_try === false && arg.indexOf('ESRI::') !== 0) {
        try {
