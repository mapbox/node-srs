...
describe('WGS84', function() {
    it('should wgs84 proj4 init detection', function() {
    ...
    it('should wgs84 proj4 literal from gdal trunk detection', function() {
    ...
    it('should wgs84 proj4 literal +datum will trigger addition to towgs detection', function() {
    ...
    it('should wgs84 wkt detection', function() {
    ...
    it('should wgs84 epsg detection', function() {
    ...
    it('should wgs84 common name detection', function() {
    ...
    it('should wgs84 proj4 literal no datum detection', function() {
    ...
    it('should wgs84 wkt from prj file', function() {
